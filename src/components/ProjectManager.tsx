  ...
  return (
    <div className="animate-in p-4 space-y-4">
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          <h2 className="text-xl font-black text-slate-900 dark:text-white">Proyectos</h2>
      ...
      <NotebookAI
        ...
        icon="📋"
        accentColor="#f97316"
        sectionContext="El usuario está en la sección 'Proyectos' de su app personal FILEHUB."
      />
    </div>
  );
};
