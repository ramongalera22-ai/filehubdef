  ...
  return (
    <div className="animate-in p-4 space-y-4">
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          <h2 className="text-xl font-black text-slate-900 dark:text-white">Work Hub</h2>
          <p className="text-xs text-slate-400">Cuaderno IA activo · Groq LLaMA 3.3</p>
        </div>
      </div>
      <NotebookAI
        sectionName="Work Hub"
        icon="💼"
        accentColor="#6366f1"
        sectionContext="El usuario está en la sección 'Work Hub' de su app personal FILEHUB."
      />
    </div>
  );
};
